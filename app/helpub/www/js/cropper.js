...
(function (global, factory) {
  ...
  function dispatchEvent(element, type, data) {
    ...
    if (element.dispatchEvent) {
       ...
       if (isFunction(Event) && window.CustomEvent != undefined && typeof window.CustomEvent == 'function') {
        if (isUndefined(data)) {
  ...
  Cropper.prototype = {
    ...
    init: function () {
      ...
      if (tagName === 'img') {
        ...
        url = element.src;
          ...
          url = element.toDataURL("image/jpeg", 0.8);
      }
	...
	console.log(!_this.built, !_this.cropped,  !SUPPORT_CANVAS)	 
        return;
      }
